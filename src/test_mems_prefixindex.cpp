...
int main(int argc, char** argv)
{
	...
	size_t prefixLen = std::stoi(argv[6]);
	std::string seq;
	{
	...
	auto prefixIndex = MEMfinder::buildPrefixIndex(index, prefixLen);
	std::string query;
	{
	...
	auto result = MEMfinder::getBestFwBwMEMs(index, query, minLength, maxCount, 1, prefixIndex, prefixLen, query.size());
